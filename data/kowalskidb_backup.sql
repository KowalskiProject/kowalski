...
--
-- Table structure for table `kowalski_user_kowalski_user_role`
--

DROP TABLE IF EXISTS `kowalski_user_kowalski_user_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kowalski_user_kowalski_user_role` (
  `kowalskiuser_k_user_id` int(11) NOT NULL,
  `kowalskiuserrole_role_id` int(11) NOT NULL,
  PRIMARY KEY (`kowalskiuser_k_user_id`,`kowalskiuserrole_role_id`),
  KEY `FK8sy0ihh2g15b7um14dcq4m7ss` (`kowalskiuserrole_role_id`),
  CONSTRAINT `FK8sy0ihh2g15b7um14dcq4m7ss` FOREIGN KEY (`kowalskiuserrole_role_id`) REFERENCES `kowalskiuserrole` (`role_id`),
  CONSTRAINT `FKkukhyjh98khauatoks3i6g8m2` FOREIGN KEY (`kowalskiuser_k_user_id`) REFERENCES `kowalskiuser` (`k_user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kowalski_user_kowalski_user_role`
--

LOCK TABLES `kowalski_user_kowalski_user_role` WRITE;
/*!40000 ALTER TABLE `kowalski_user_kowalski_user_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `kowalski_user_kowalski_user_role` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `kowalskiuserrole`
--

DROP TABLE IF EXISTS `kowalskiuserrole`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kowalskiuserrole` (
...
--
-- Dumping data for table `kowalskiuserrole`
--

LOCK TABLES `kowalskiuserrole` WRITE;
/*!40000 ALTER TABLE `kowalskiuserrole` DISABLE KEYS */;
INSERT INTO `kowalskiuserrole` VALUES (1,'admin'),(2,'developer'),(3,'manager'),(4,'auditor');
/*!40000 ALTER TABLE `kowalskiuserrole` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-03-20 12:27:16
